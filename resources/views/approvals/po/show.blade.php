                ...
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('approvals.po.index') }}" class="btn btn-outline-secondary btn-sm ms-2">
        ...
        $(document).on('click', '.view-attachment-btn', function(e) {
            ...
            if (fileSize === 'Unknown' || fileSize === 'Invalid size') {
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid File',
                    text: 'This file appears to be corrupted or invalid. Please contact your administrator.',
