    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-info">
                <h5 class="mb-0"><i class="fas fa-file-alt mr-2"></i>Purchase Request (PR) Sync</h5>
            </div>
            <div class="card-body">
                <!-- Last Sync Info -->
                @if($lastSync)
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group mb-2" role="group">
                        <button type="button" class="btn btn-sm btn-outline-primary" id="pr-today-btn">TODAY</button>
                        <button type="button" class="btn btn-sm btn-outline-primary" id="pr-yesterday-btn">YESTERDAY</button>
                    ...
                    <div id="pr-custom-date-range" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="pr-start-date" name="start_date">
                            </div>
                            <div class="col-md-6">
                                <label for="pr-end-date">End Date</label>
                                <input type="date" class="form-control" id="pr-end-date" name="end_date">
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="pr-selected-start-date">
                    <input type="hidden" id="pr-selected-end-date">
                </div>

                <!-- Action Buttons -->
                <div class="form-group">
                    <button type="button" class="btn btn-info" id="pr-sync-btn">
                        <i class="fas fa-sync mr-2"></i>Sync PR from SAP
                    </button>
                    <button type="button" class="btn btn-danger ml-2" id="pr-truncate-btn">
                        <i class="fas fa-trash mr-2"></i>Clear PR Temp Table
                    </button>
                </div>

                <!-- Results Display -->
                <div id="pr-results" style="display: none;"></div>
            </div>
        </div>
    </div>
</div>
